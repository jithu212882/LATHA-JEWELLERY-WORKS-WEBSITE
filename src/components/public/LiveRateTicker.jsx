...
export default function LiveRateTicker() {
  ...
  const rateItems = [
    { label: '22K GOLD', rate: gold_rates.rate_22k || '12,182', unit: '/g' },
    { label: '24K GOLD', rate: gold_rates.rate_24k || '13,289', unit: '/g' },
    { label: '18K GOLD', rate: gold_rates.rate_18k || '9,967', unit: '/g' },
