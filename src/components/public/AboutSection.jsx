...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-14 sm:py-20 md:py-28 max-w-7xl mx-auto px-4 md:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 bg-[#1C1B1A] p-2 border border-[#2A2A2A] rounded-xl overflow-hidden shadow-2xl">
            <div
              className="h-[280px] sm:h-[420px] bg-cover bg-center rounded-lg relative"
              style={{ backgroundImage: `url('${image}')` }}
            >
              <div className="absolute bottom-3 right-3 bg-[#121212]/95 backdrop-blur-md border border-accent-gold/40 rounded-xl p-2 flex items-center gap-2.5 shadow-2xl">
                <div className="w-9 h-9 rounded-lg overflow-hidden border border-accent-gold/40 p-0.5 bg-[#121212] shrink-0">
                  <img
                ...
                <div className="flex flex-col text-left pr-1">
                  <span className="text-[10px] font-bold text-accent-gold uppercase tracking-wider">Official Hallmark</span>
                  <span className="text-[9px] text-[#F5F2EB]/60 uppercase tracking-widest">Est. 1990</span>
                </div>
              </div>
            </div>
          </div>
