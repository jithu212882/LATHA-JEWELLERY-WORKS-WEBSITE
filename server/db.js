...
function seedInitialData() {
  ...
  if (Object.keys(store.business_settings).length === 0) {
    store.business_settings = {
      ...
      address: 'Chathencode to Nadaikkavu Road, Near Government Primary School, Nadaikavu, Tamil Nadu',
      plus_code: '74VX+7G Nadaikavu, Tamil Nadu',
      google_maps_url: 'https://www.google.com/maps/search/?api=1&query=74VX%2B7G+Nadaikavu%2C+Tamil+Nadu',
